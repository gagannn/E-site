...
<body>
	...
	<div class="background-image">
		<div class="signup-form">
			<f:form action="${contextRoot}/submitCategory" modelAttribute="key1"
				method="post" enctype="multipart/form-data">
				<h2>${formLabel}</h2>
				<p>Please fill in this form to add a category!</p>
				<c:if test="${not empty op}">
					<div class="form-group">
						<f:input type="text" path="categoryId" class="form-control"
							id="categoryId" placeholder="Category Id" name="categoryId"
							readonly="true" />
				...
				<div class="form-group">
					<f:input type="text" path="categoryName" class="form-control"
						id="categoryName" placeholder="Category Name" name="categoryName" />
					<f:errors path="categoryName" style="color:red;" />
				</div>
				<div class="form-group">
					<f:input type="text" path="categoryDescription"
