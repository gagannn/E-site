			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					...
					<div class="carousel-caption d-none d-md-block">
						...
						<p>
							<a href="${contextRoot}/getAllProducts">
			...
			<c:forEach items="${threeRandomProducts}" var="catObj">
				...
				<div class="col-md-4 text-center content">
					<a
						...
						<p class="red-color">View All</p> <img
		...
		<div class="main-container ">
			<div class="row">
				<div class="background-side-container  ">
					<a href="${contextRoot}/getProductsByCategory/${catObj.categoryId}"
						id="links">
