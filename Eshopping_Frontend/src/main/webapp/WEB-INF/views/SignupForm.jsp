...
<body>
	...
	<div class="signup-form">
	 <f:form action="${contextRoot}/signupUser" modelAttribute="key1" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-6"><f:input type="text"  path="firstName" class="form-control" id="firstName" name="firstName" placeholder="First Name"/>
    <f:errors path="firstName" style="color:red;"/></div>
				<div class="col-xs-6"><f:input type="text"  path="lastName" class="form-control" id="lastName" name="lastName" placeholder="Last Name"/>
    <f:errors path="lastName"/></div>
			</div>        	
        </div>
        <div class="form-group">
        	<f:input type="email" path="email" class="form-control" id="email" placeholder="Email" name="email"/>
    <f:errors path="email" style="color:red;"/>
  	...
  	<f:errors path="password" style="color:red;"/>
		...
		<div class="form-group">
             <f:input type="password2"  path="password2" class="form-control" id="password2" placeholder="Confirm Password" name="password2"/>
