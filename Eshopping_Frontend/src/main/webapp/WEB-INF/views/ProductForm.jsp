...
<body>
	...
	<div class="container container-size">
		...
		<f:form action="${contextRoot}/submitProduct" method="post"
			...
			<div class="form-group">
				<div class="row">
					<label for="pimage1" class="control-label col-sm-3 text-center">
						Upload Image1 : <c:if test="${not empty op}">
					...
					<div class="col-sm-9">
						<div class="custom-file">
							<f:input type="file" class="custom-file-input" id="pimage1"
								path="pimage1" multiple="multiple" />
							<label class="custom-file-label" for="pimage1">Choose
								file...</label>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-3 text-center">
						<label class="control-label" for="sel1">Category Type:</label>
					</div>
					<div class="col-sm-9 ">
