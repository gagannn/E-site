...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5">
				<p class="product-topic">${prodObj.productName}
					${prodObj.category.categoryName}</p>
				<div class="abc" style="margin-left: 10px;">
						...
						<c:when test="${prodObj.quantity > 0}">
							<sec:authorize access="isAnonymous()">
								<a href="${contextRoot}/addToCart/${prodObj.productId}"
									...
									style="font-color: black !important;"> Add to Cart <span
					...
					<sec:authorize access="hasAuthority('Role_Admin')">
						<a href="${contextRoot}/editProduct/${prodObj.productId}"
							...
							style="font-color: black !important;"> Edit <span
							class="glyphicon glyphicon-edit"></span></a>
						<a href="${contextRoot}/deleteProduct/${prodObj.productId}"
							class="btn btn-danger" role="button"
							style="font-color: black !important;"> Delete <span
