...
<body>
	...
	<div class="background-image">
		<div class="signup-form">
			<f:form action="${contextRoot}/submitSupplier" modelAttribute="key1"
				method="post" enctype="multipart/form-data">
				<h2>${formLabel}</h2>
				<p>Please fill in this form to add a supplier!</p>
				<c:if test="${not empty op}">
					<div class="form-group">
						<f:input type="text" path="supplierId" class="form-control"
							id="supplierId" placeholder="Supplier Id " name="supplierId"
							readonly="true" />
						<f:errors path="supplierId" style="color:red;" />
					</div>
				</c:if>
				<div class="form-group">
					<f:input type="text" path="suppName" class="form-control"
						id="suppName" placeholder="Supplier Name" name="suppName" />
					<f:errors path="suppName" style="color:red;" />
				</div>
				<div class="form-group">
					<f:input type="text" path="suppMobile" class="form-control"
						id="suppMobile" placeholder="Supplier Mobile" name="suppMobile" />
					<f:errors path="suppMobile" style="color:red;" />
				</div>
				<div class="form-group">
					<f:input type="text" path="address" class="form-control"
						id="address" placeholder="Supplier Address" name="address" />
			...
			<div class="hint-text">
				<span style="color: white">Go back to Home?</span> <a
					href="${contextRoot}/">Click here</a>
			</div>
		</div>
	</div>
